...
const {
  ...
  error,
  refetch,
} = useFinalInspections(queryParams);
    ...
    >
      <div>
        ...
        <p class="text-[10px] lg:text-xs text-slate-500 dark:text-slate-400">
          List of PCBs processed through Final Inspection station.
        </p>
      </div>
                  ...
                  <div class="flex flex-col items-center justify-center">
                    ...
                    >
                      {{
                        ...
                        error?.message ||
                        "An unexpected error occurred while fetching final inspection data."
                      }}
                    </p>
                    <button
                      @click="refetch()"
