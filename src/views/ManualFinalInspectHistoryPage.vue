...
import { useManualFinalInspections } from "@/hooks/useFinalInspection";
...
const {
  ...
  error,
  refetch,
} = useManualFinalInspections(queryParams);
...
const records = computed(() => {
  if (
    finalInspections.value?.data &&
    Array.isArray(finalInspections.value.data)
  ) {
  ...
  <div class="space-y-4">
    ...
    >
      <div>
        ...
        >
          Manual Final Inspection History
        </h3>
        <p class="text-[10px] lg:text-xs text-slate-500 dark:text-slate-400">
          List of PCBs processed through manual final inspection.
        </p>
      </div>
      ...
      <div class="overflow-x-auto min-h-75">
        <table class="w-full text-left text-xs whitespace-nowrap">
          <thead>
            ...
            >
              <th class="px-4 py-2.5 font-black">QR Code</th>
              <th class="px-4 py-2.5 font-black">Operator</th>
              <th class="px-4 py-2.5 font-black">Created By</th>
          ...
          <tbody class="divide-y divide-slate-50 dark:divide-slate-700/50">
            <template v-if="isLoading">
              <tr v-for="i in 5" :key="'skeleton-' + i" class="animate-pulse">
                ...
                <td class="px-4 py-3">
                  <div
                    class="h-3 bg-slate-200 dark:bg-slate-700 rounded w-16"
                  ></div>
                </td>
              </tr>
            </template>
            <template v-else-if="records.length > 0">
              ...
              >
                <td
                  class="px-4 py-2.5 font-bold text-slate-700 dark:text-slate-200 font-mono"
                >
                  {{ item.qrCode }}
                </td>
                <td
