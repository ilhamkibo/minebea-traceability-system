...
<template>
  <div class="flex flex-wrap gap-4 items-center justify-center">
    ...
    <div class="relative w-full group max-w-md px-2 lg:px-0">
      ...
      />
      <Search
        class="absolute left-4 lg:left-3 top-1/2 -translate-y-1/2 text-slate-400 w-4 h-4"
      />
    </div>
    <!-- Filter date -->
    <div class="flex items-center gap-2">
      ...
      <div
        class="flex items-center gap-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl px-3 py-1 shadow-sm"
      >
        <input
        ...
        />
        <label
          class="flex items-center gap-1.5 ml-1 border-l border-slate-200 dark:border-slate-700 pl-3 cursor-pointer group"
        >
          <div
            class="relative flex items-center justify-center w-3.5 h-3.5 rounded-sm border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-900 group-hover:border-brand-accent transition-colors overflow-hidden"
          >
            <input
              type="checkbox"
              :checked="isSingleDay"
          ...
          <span
            class="text-[10px] lg:text-xs text-slate-500 dark:text-slate-400 font-medium select-none group-hover:text-slate-700 dark:group-hover:text-slate-300 transition-colors"
            >1 Day</span
          >
        </label>
      </div>
      ...
      <!-- Item Status Filter -->
      <div
        class="bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl flex overflow-hidden whitespace-nowrap text-[10px] lg:text-xs transition-colors shadow-sm"
      >
        <button
